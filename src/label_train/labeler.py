...
class TrainSettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.sp_epochs = QSpinBox(); self.sp_epochs.setRange(1, 500); self.sp_epochs.setValue(45)
        self.sp_batch  = QSpinBox(); self.sp_batch.setRange(1, 256);  self.sp_batch.setValue(64)
        self.sp_lr     = QDoubleSpinBox()
        self.sp_lr.setRange(1e-6, 0.5); self.sp_lr.setSingleStep(0.0001)
        self.sp_lr.setDecimals(6); self.sp_lr.setValue(0.0003)
        ...
        self.le_search_epochs = QLineEdit("45")
        self.le_search_batch  = QLineEdit("64")
        self.le_search_lr     = QLineEdit("0.0003")
        self.le_search_k      = QLineEdit("1")
